        ...
        <div class="mx-auto col-sm-6">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">Registrar Carpeta</h4>
                </div>
                <div class="card-body">
                <form class="form"  autocomplete="on" method="POST" action="{{ route('folders.store') }}">
                        @csrf

                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Nombre Del Carpeta</label>
                            <div class="col-lg-9">
