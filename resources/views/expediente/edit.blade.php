    ...
    <div class="row">
        ...
        <form method="POST" action="{{ route('expedientes.update', [$expediente->id]) }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <input class="form-control" id="nombre" type="text" class="validate" name="nombre" value="{{$expediente->nombre}}" required>
                </div>
                <br>
                @error('nombre')
                ...
                @enderror
                              ...
                              <div class="form-group row">
                            <select class="form-select"  id="grupo" name="folder_id">
                                <option selected>selecciones un folder</option>
